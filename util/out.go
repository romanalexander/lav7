...
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014CC6C0>)
// 
...
// // An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'TypeError'>, TypeError("'int' object is not subscriptable",), <traceback object at 0x014CC6E8>)
// 
...
// // An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'TypeError'>, TypeError("'int' object is not subscriptable",), <traceback object at 0x014CC378>)
// 
...
// // An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'TypeError'>, TypeError("'int' object is not subscriptable",), <traceback object at 0x014CCD00>)
// 
...
// An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014CCDC8>)
// 
...
// An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014CCF08>)
// 
...
// An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014CCF58>)
// 
...
// An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014CCEE0>)
// 
...
// An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014D3760>)
// 
...
func (i *%s) Read(buf *buffer.Buffer){
    i.Long = buf.ReadEid()
    // Unexpected code:Slot Slots[0]
    // Unexpected code:Slot Slots[1]
    // Unexpected code:Slot Slots[2]
    // Unexpected code:Slot Slots[3]
}
...
// An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'TypeError'>, TypeError("'int' object is not subscriptable",), <traceback object at 0x014D3620>)
// 
...
// // An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014D36C0>)
// 
...
// An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014D3620>)
// 
...
// // An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014D3738>)
// 
...
// An exception was thrown while parsing/converting PocketMine-MP protocol.
// Please read original PHP code and port it manually.
// Exception: (<class 'IndexError'>, IndexError('string index out of range',), <traceback object at 0x014D3788>)
// 
